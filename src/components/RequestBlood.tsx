...
const RequestBlood: React.FC<RequestBloodProps> = ({ language, user, prefillData }) => {
  ...
  const updateMapMarker = React.useCallback((lat: number, lng: number) => {
    ...
    const icon = L.divIcon({
      ...
      html: `<div style="width: 30px; height: 30px; background: #dc2626; border: 4px solid white; border-radius: 50% 50% 50% 0; transform: rotate(-45deg); box-shadow: 0 4px 15px rgba(220, 38, 38, 0.6); position: relative;">
